                ...
                <div>
                    ...
                    <div class="relative">
                        <select name="product_id" required
                            class="w-full px-4 py-2.5 bg-slate-50 border border-slate-300 rounded-lg focus:ring-2 focus:ring-primary/20 focus:border-primary outline-none appearance-none transition-colors cursor-pointer">
                ...
                <div>
                    ...
                    <div class="relative">
                        <input type="number" name="quantity" min="1" required placeholder="0"
                            class="w-full px-4 py-2.5 bg-slate-50 border border-slate-300 rounded-lg focus:ring-2 focus:ring-primary/20 focus:border-primary outline-none transition-colors font-bold text-slate-800">
